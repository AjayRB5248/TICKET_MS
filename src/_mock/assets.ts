...
export const _tourNames = [
  'Live in Concert Extravaganza',
  'Classical Music Under the Stars',
  'Cinema Under the Moonlight',
  'Artists Showcase Gala',
  'Rock and Roll Festival',
  'Jazz Nights Serenade',
  'Cultural Dance Spectacular',
  'Gourmet Food and Wine Fair',
  'Literary Arts Symposium',
  'Theater and Drama Festival',
  ...
  'Street Art and Graffiti Exhibit',
  'Vintage and Antique Bazaar',
  'Science and Astronomy Convention',
  'Adventure Sports Challenge',
  'Indie Music Showcase',
  'Culinary Chef Battles',
];
